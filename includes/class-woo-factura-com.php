...
if (!class_exists('WooFacturaCom')) {
    ...
    final class WooFacturaCom {
        ...
        private function init_debug() {
            // Debug simple
            if (WP_DEBUG) {
                error_log('WooFacturaCom: Plugin inicializado correctamente');
            }
        }
        ...
        public function welcome_notice() {
            ...
            echo __('Plugin activado correctamente. Ve a WooCommerce → Factura.com para configurar.', 'woo-factura-com') . '</p>';
            echo '</div>';
        }
